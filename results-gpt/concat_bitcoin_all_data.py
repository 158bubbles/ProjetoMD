...
for i in range(29):
    dataset_file = f"results-gpt/data_bitcoin/dataset_{i}.json"
    resultados_file = f"results-gpt/data_bitcoin/resultado_{i}.json"
...
csv_file = "results-gpt/bitcoin_sentiment_gpt_data.csv"
